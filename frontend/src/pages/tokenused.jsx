    ...
    <>
      ...
      >
        ...
        <div className="mx-auto max-w-md text-center mt-10 bg-white p-10 rounded-lg shadow-xl">
          <XIcon className="mx-auto h-12 w-12 text-green-500" />
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            Token Used
          </h1>
          <p className="mt-4 text-muted-foreground">
            This user has already been verified and the activation link is no
            longer valid. This happens when the token has already been used to
            activate your account. Each activation link can only be used once.
